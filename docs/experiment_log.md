...
[x] 8. Chuẩn bị ISIC 2019 Kaggle Dataset
[x] 9.  git add .dvc + commit + push
[x] 10. Tạo tập sample 50 ảnh (6-7 ảnh/lớp) + CSV tương ứng
[x] 11. Tạo project trên W&B, lưu API key vào .env
[x] 12. Tạo Kaggle Notebook
[x] 13. Clone GitHub Repo
[x] 14. Kết nối ISIC 2019 Kaggle Dataset
[x] 15. Tạo thư mục docs/, lưu project_plan.md
```
